...
Devise.setup do |config|
  ...
  # config.secret_key = '17cac70d39f7895dbb2c071de5393f9dea339aaa39
  # 1c3a07fdd7a475ad8a492577a3d6fc0d87c
  # cc9408ee2e8a7cb424c2fc6c0b35041e491ca5dc653b3e3e288'
  ...
  # for bcrypt (the default
  # algorithm), the cost increases exponentially with
  # the number of stretches (e.g.
  # a value of 20 is already extremely slow: approx.
  # 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 11

  # Set up a pepper to generate the hashed password.
  # config.pepper = 'cc9eefff9efcd678d405fdaf2ef6f8598eefbfd80fc
  # 84bcbcf383de0b58cf5b4f272b677
  # 49e167ecc46912ffdda26fc5b54f311ad9945e2831df3c7ded5b3071'
  ...
  # When set to false, does not sign a user in
  # automatically after their password is
  ...
  # :clearance_sha1, :authlogic_sha512 (then you should
  # set stretches above to 20
  ...
  # change the failure app, you can configure them inside
  # the config.warden block.
  #
